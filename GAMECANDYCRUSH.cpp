...
/*The function printalgo prints the entire board in
easy mode with a borderand Guidelines across the rowand column*/
...
/*The function printalgo2 prints the entire board in easy mode with a borderand Guidelines across the rowand column.
This function also prints an arrow nexxt to the selected candy*/
...
/*The function rnd3 scans the whole board in easy mode repeatedly for any possible matches(3 in a row).
This function also shows the matches by a blinking animation and indicates through bool if a match is found or not.*/
